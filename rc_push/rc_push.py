...
@click.option('--user', '-u', help='Rocket.Chat user name')
@click.option('--password', '-p', help='Rocket.Chat user password')
@click.option('--rc-url', '-r', help='Rocket.Chat URL')
@click.option('--ntfy-url', '-n', help='URL of your ntfy instance')
@click.option('--ntfy-topic', '-t', help='Topic in ntfy')
@click.option('--ntfy-user', '-U', help='User name in ntfy')
@click.option('--ntfy-pass', '-P', help='User password in ntfy')
